...
STRINGS: dict[str, dict] = {
    "zh": {
        ...
        "overview_sections": ("章节导航", "如何使用本 Wiki", "术语表"),
        ...
        "site": {
            "overview_label": "总览",
            "knowledge_label": "知识库",
            "llms_desc": "repowiki 为仓库 {repo} 生成的结构化 Wiki：以下链接按章节索引全部 markdown 页面，llms-full.txt 为全文合并版。",
    ...
    "en": {
        ...
        "flow_sections": [
            ...
            ("Flow Overview", "exact"),
            ("Key Steps", "exact"),
            ("Involved Components", "exact"),
            ("Data and State Changes", "exact"),
            ("Troubleshooting", "prefix"),
            ("Conclusion", "exact"),
        ],
        "layer_sections": [
            ("Introduction", "exact"),
            ("Layer Overview", "exact"),
            ("Layer Responsibilities", "exact"),
            ("Layer Dependencies and Call Rules", "exact"),
            ("Vertical Slice", "prefix"),
            ("Cross-Cutting Concerns", "exact"),
            ("Troubleshooting", "prefix"),
            ("Conclusion", "exact"),
        ],
        "data_sections": [
            ("Introduction", "exact"),
            ("Data Model Overview", "exact"),
            ("Core Entity Analysis", "exact"),
            ("State Machine", "exact"),
            ("Storage and Serialization", "exact"),
            ("Data Lifecycle", "exact"),
            ("Troubleshooting", "prefix"),
            ("Conclusion", "exact"),
        ],
        "api_sections": [
            ("Introduction", "exact"),
            ("Endpoint Inventory and Grouping", "exact"),
            ("Request Handling Sequence", "exact"),
            ("API Contracts and Error Codes", "exact"),
            ("Authentication and Access Control", "exact"),
            ("Quotas", "prefix"),
            ("Troubleshooting", "prefix"),
            ("Conclusion", "exact"),
        ],
        "event_sections": [
            ("Introduction", "exact"),
            ("Event Inventory", "exact"),
            ("Event Flow Topology", "exact"),
            ("Event Contracts", "exact"),
            ("Consumer Handling", "exact"),
            ("Reliability Guarantees", "exact"),
            ("Troubleshooting", "prefix"),
            ("Conclusion", "exact"),
        ],
        "overview_h1_suffix": "Wiki Overview",
        "overview_sections": ("Section Navigation", "How to Use This Wiki", "Glossary"),
        ...
        "site": {
            ...
            "llms_desc": "Structured wiki for the repository '{repo}', generated by repowiki: the links index every markdown page by chapter; llms-full.txt holds the concatenated full text.",
