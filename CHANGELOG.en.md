...
- README (EN) command table now documents the global `-o/--output` option.

### Tests

- New `tests/test_output_dir.py`: output-dir plumbing across plan/next/check/site and scanner self-ignore.
